...
-- AddForeignKey
ALTER TABLE "transactions" ADD CONSTRAINT "transactions_transaction_category_id_fkey" FOREIGN KEY ("transaction_category_id") REFERENCES "categories"("id") ON DELETE SET NULL ON UPDATE CASCADE;
